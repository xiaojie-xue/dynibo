...
pub struct Workspace {
    ...
    pub(super) derivative_omegas: Vec<Vector3<f64>>,
    pub(super) derivative_alphas: Vec<Vector3<f64>>,
...
impl Workspace {
    pub(super) fn new(model_id: u64, joint_count: usize, generalized_count: usize) -> Self {
        Self {
            ...
            derivative_omegas: vec![Vector3::zeros(); joint_count],
            derivative_alphas: vec![Vector3::zeros(); joint_count],
